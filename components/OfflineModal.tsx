...
export const OfflineModal: React.FC<OfflineModalProps> = ({ gains, timeOffline, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[70] flex items-center justify-center bg-black/90 backdrop-blur-md p-4 animate-in fade-in duration-500">
      <div className="relative w-full max-w-md overflow-hidden rounded-2xl border-2 border-eldritch-gold/30 bg-eldritch-dark shadow-[0_0_100px_rgba(197,160,89,0.2)]">
