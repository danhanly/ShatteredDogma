  ...
  <BaseModal onClose={onClose} zIndex={120} containerClassName="max-w-lg w-full border-red-900" backdropClassName="bg-black/95 backdrop-blur-xl">
    ...
    <div className="p-8 text-center">
      ...
      <div className="rounded-lg bg-black/40 p-4 border border-red-900/30 mb-8">
          ...
          <p className="text-gray-400 text-xs">Zealot worshippers now consume the souls of the Indolent, the Lowly and the Worldly to sustain themselves. Manage your supply of all your worshippers if you wish to grow the Zealots.</p>
      </div>
